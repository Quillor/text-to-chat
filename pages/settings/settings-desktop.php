<div class="settings-desktop  pt-3 pb-5">
    <div class="px-md-5 px-3">
        <div class="d-flex align-items-end w-100 col-md-8 mx-auto">
            <p class="phone pb-0 mb-0"><span  class="label-text d-block">My Number</span><i class="fas fa-phone"></i> <spanc class="bold pl-1 pr-2">123-123-1234</span></p>
            <div class="box-icon ml-md-5"><p class="mb-0 pb-0"><i class="far fa-copy"></i> </p></div>
        </div>
        

        <div class="d-flex align-items-end justify-content-between w-100 border-bottom mb-4">
            <div class="">
        ...
        <div class="mx-auto col-md-8 col-12 profile-details">
            <div class="row mb-3">
            ...
            <div>
                <button class="btn btn-custom-secondary bold">RESET PASSWORD <i class="fas fa-lock pl-2"></i></button>
            </div>
        ...
        <div class="mx-auto col-md-8 col-12 company-details">
            <div class="row mb-3">
                <div class="col-md-6 col-12 mb-2">
                    <p class=" pb-0 mb-0">
